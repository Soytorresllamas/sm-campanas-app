...
const HEADERS = [
  ...
  'Valor Real de Colegio', 'Gerencia Responsable', 'Ejecutivo Responsable', 'Años de Antigüedad',
...
// Filas de ejemplo (borrarlas antes de la carga real).
const EJEMPLOS = [
  ['Instituto Cumbres del Valle', 'CRM-000123', 'MX-0451', 'SMART', 'Top', 985000, 'Gerencia Centro', 'Mariana López', 12,
    'Acierta', 'Acierta', 'Acierta', '', 'Bright Sparks', 'Bright Sparks', 'Winglish', '', ''],
  ['Colegio Nuevo Amanecer', 'CRM-000348', 'MX-1102', 'CORE', 'Medio', 310000, 'Gerencia Norte', 'Jorge Ramírez', 5,
    '', 'Revuela Up', 'Revuela Up', '', '', 'Winglish', 'Winglish', '', ''],
  ['Centro Escolar Monte Albán', 'CRM-000891', 'MX-0779', 'CORE', 'Bajo', 145000, 'Gerencia Sur', 'Jorge Ramírez', 22,
...
const INSTRUCCIONES = [
  ...
  ['Ejecutivo Responsable', 'Recomendada', 'Texto (nombre completo)', 'Se convierte en el asesor del colegio: si no existe se crea y el colegio queda asignado a él.'],
